...
const Main = {// objeto principal de controle

  tasks: [],

  init: function() { // chamar função 
    this.cacheSelectors()
    this.bindEvents()
    this.getStoraged()
    this.buildTasks()
  ...
  cacheSelectors: function() { // selecionar elemento
  ...
  bindEvents: function() { // adicionar evento
    const self = this // usar o this do main , por padrão é o this do scope da função
  ...
  Events: {
    ...
    removeButton_click: function(e){
      ...
      setTimeout(function(){// timeout e add da classe para fazer a li desaparecer
        li.classList.add('hidden')
      },300)// tempo de acordo com a animação
    }
  }
